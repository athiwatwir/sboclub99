$(document).ready(function () {
    ...
    function createLine(epoch, league_detail, home_team, home_team_logo, away_team, away_team_logo,type) {
        ...
        str = str + '     <img class="w-100 rounded-circle" src="' + home_team_logo + '" alt="Image Description">';
        str = str + ' </div>';
        str = str + ' <div class="col-md-2 col-4">';
        str = str + '     <img class="w-100 rounded-circle" src="' + away_team_logo + '" alt="Image Description">';
        str = str + ' </div>';
