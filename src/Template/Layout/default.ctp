...
<html lang="en">
    <head>
        <!-- Title -->
        <title><?=isset($title)?$title.' สุดยอดเว็บ คาสิโน พนันบอลออนไลน์ แทงบอลสด':'สุดยอดเว็บ คาสิโน พนันบอลออนไลน์ แทงบอลสด'?></title>
    ...
    <body>
        ...
        <main>
            ...
            <div class="qrcode_sticky" id="qrcode_sticky">
                ...
                <a href="https://lin.ee/h7uP7Bl" target="_blank">
        ...
        <script type="text/javascript">
            (function () {
                var options = {
                    ...
                    line: "//lin.ee/h7uP7Bl", // Line QR code URL
